...
def get_parser():
    ...
    # 主要算法级别参数
    parser.add_argument("--ae_prob", type=float, default=0.0, help="应用 AE 重建增广的概率 (0-1)")
    ...
    parser.add_argument("--test_data_root", type=str, default=r'E:\00_fjw\00_data\FF++\FaceForensics++_C23_split_cropped')
    ...
    # 模型相关
    parser.add_argument("--model_name", type=str, default="resnet50") #efficientnet_b0, openai/clip-vit-large-patch14
